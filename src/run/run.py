...
def run(_run, _config, _log):
    ...
    if args.use_tensorboard:
        tb_logs_direc = os.path.join(dirname(dirname(dirname(abspath(__file__)))), args.local_results_path, "tb_logs_mask")
...
def run_sequential(args, logger):
    ...
    while runner.t_env <= args.t_max:
        ...
        if args.save_model and (
            ...
            save_path = os.path.join(args.local_results_path, "models", args.log_model_dir, args.unique_token, "mask_difficult_3",
                                     str(runner.t_env))
