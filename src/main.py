...
setproctitle.setproctitle("-".join(["pad+gen", "test_ssl_lr=0.001"]) + "@" + "ceshi")


if __name__ == '__main__':
    # normal
    params = ['src/main.py', '--config=vdn', '--env-config=sc2', 'with', 'obs_agent_id=True',\
              'obs_last_action=False', 'runner=parallel', 'batch_size_run=10', 'buffer_size=10', 'batch_size=256',\
              't_max=10050000', 'batch_size=128']
